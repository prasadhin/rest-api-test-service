...
public class DataBodyEntityTests {
    ...
    public void checkTwoDataBodiesAreEqualAsExpected() {
        ...
        assertThat(dataBodyEntity1.getDataHeaderEntity().getBlocktype())
                .isEqualTo
                        (dataBodyEntity2.getDataHeaderEntity().getBlocktype());
        assertThat(dataBodyEntity1.getDataHeaderEntity().getName())
                .isEqualTo
                        (dataBodyEntity2.getDataHeaderEntity().getName());
    }
}
